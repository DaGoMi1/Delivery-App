    ...
    <div>
      <div className='sticky top-0 z-10 p-4 bg-[rgb(42,193,188)]'>
        <form className='relative' onSubmit={submitSearchTerm}>
          <input className='w-full  border-1 rounded-xl p-1 pl-4 caret-[var(--color-mainColor)] focus:outline-[var(--color-mainColor)] bg-white' type="text" placeholder='찾는 맛집 이름이 뭐예요?'/>
          <i class="fa-solid fa-magnifying-glass absolute right-2 top-2 text-[var(--color-mainColor)]"></i>
        </form>
      </div>
